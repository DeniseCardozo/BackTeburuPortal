...
public class ProyectoController {
    ...
    public ResponseEntity<Proyecto> getProyectoById(@PathVariable Integer id_proyecto) throws ErrorProcessException {
        return ResponseEntity.ok(service.buscarProyectoByIdServicio(id_proyecto));
    }

    @PostMapping
    @ApiOperation(value = "Crear proyecto")
    public ResponseEntity<Proyecto> postNuevoProyecto(@Valid @RequestBody Proyecto proyecto) throws ErrorProcessException {
