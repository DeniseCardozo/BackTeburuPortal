...
public class ArchivoController {
    ...
    public String uploadFiles(@RequestParam("files") MultipartFile multipartFiles, @PathVariable Integer id_tabla, @PathVariable Integer id_usuario) throws IOException {
